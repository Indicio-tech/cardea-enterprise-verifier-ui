//First declare initialState, contains all state tracked by this reducer
...
//Action constants. Always all caps, never change, use an underscore between words. Used to call the 'action' which is redux's word for function.
...
//Actions = how we interact with redux state. function that is exported from this file.
//Actions always return an object with two properties. type = action constant, and payload = the data needed to complete the change.
